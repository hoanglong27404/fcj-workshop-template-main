...
3. You should see all the tables created by your CDK stack:
...
3. You should see the listing you created in Test Case 2.
...
4. You should see the admin user profile created in Section 5.4:
