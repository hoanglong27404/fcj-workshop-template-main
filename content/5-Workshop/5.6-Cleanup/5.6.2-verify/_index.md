...
3. If it still exists, select it and click **Actions** → **Delete**.

## E. Check API Gateway
1. Go to the API Gateway Console
2. Verify that `FindNestAPI` is deleted
3. If it still exists, select it and click **Actions** → **Delete API**.
...
1. Go to the Amazon Location Service Console
